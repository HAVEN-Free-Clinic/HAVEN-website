        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-10 md:mb-14">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#00356b] text-white font-['Poppins',sans-serif] font-semibold text-[18px] md:text-[20px] px-8 py-3.5 hover:bg-[#00356b]/90 transition-colors"
            >
              Learn More
          ...
          <div>
            ...
            <div className="space-y-6 font-['Poppins',sans-serif] text-black text-[16px] sm:text-[17px] md:text-[18px] leading-relaxed">
              <p>
                ...
                received his medical degree from the University of Rochester School
                of Medicine. In 1943, at the conclusion of his residency training
                at Strong Memorial Hospital in Rochester, he was drafted into the
                United States Army Medical Corps, where he served as a Captain and
                orthopedic surgeon in the Fortieth General Hospital. After staging
                in England, his unit was the first Hospital Group to enter Paris
                after the Invasion of Normandy, and he remained in the Army until
                1946.
              </p>
              ...
              <blockquote className="border-l-4 border-[#00356b]/30 pl-6 md:pl-8 py-2 bg-[#f7f9fc] pr-6 md:pr-8">
                <p className="italic">
                  ...
                  helped me to understand things about growing up and being
                  &ldquo;me&rdquo; I never before understood. He smoked
                  (didn&apos;t all doctors smoke in the &apos;50s?) and I will
                  never forget seeing the slow arc of his burning cigarette as he
                  rocked back and forth during our evening talks. That friendship
                  lasted for 30 years, with so many times shared, so many fond
                  memories.
                </p>
              </blockquote>
