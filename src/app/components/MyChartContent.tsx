...
const features = [
  {
    ...
    description: "Send and receive secure messages directly with your care team.",
  },
  {
    icon: CalendarCheck,
    title: "Schedule & Cancel Appointments",
    description: "Manage your upcoming visits and make changes to your schedule.",
  },
  {
    icon: CalendarPlus,
    title: "Request New Appointments",
    description: "Request a new appointment with your provider at your convenience.",
  },
  {
    icon: FileText,
    title: "Request Medical Records",
    description: "Access and download your medical records and visit summaries.",
  },
  {
    icon: Pill,
  ...
  },
  {
    ...
    description: "View lab results and test reports as soon as they become available.",
  },
  {
    icon: ShieldCheck,
    title: "View Allergies & Medications",
    description: "Keep track of your allergy information and current medications.",
  },
  {
    icon: UserCog,
    title: "Update Personal Information",
    description: "Keep your contact details, insurance, and preferences up to date.",
  },
];
...
const resources = [
  { label: "MyChart FAQ (YNHHS)", url: "https://www.ynhhs.org/patients-visitors/mychart" },
  { label: "HAVEN Clinic Contact", url: "/contact" },
    ...
    <section className="bg-white w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="font-['Poppins',sans-serif] text-black/75 text-[16px] sm:text-[17px] md:text-[18px] leading-relaxed mb-4">
              MyChart is a free, secure online portal that gives you access to your
              HAVEN Free Clinic health information anytime, anywhere. Manage appointments,
              message your care team, view test results, and more.
            </p>
            <p className="font-['Poppins',sans-serif] text-black/75 text-[15px] md:text-[16px] leading-relaxed mb-6 md:mb-8">
              To get started, you&apos;ll need an <span className="font-semibold text-[#00356b]">activation code</span>.
              You can receive one during your next visit, from your after-visit summary,
              or by requesting one at the front desk.
            </p>
            <a
              href={MYCHART_LOGIN_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#00356b] text-white font-['Poppins',sans-serif] font-semibold text-[16px] md:text-[18px] px-8 py-3.5 rounded-full hover:bg-[#4a90c4] transition-colors duration-300"
            >
              Log In to MyChart
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-['Poppins',sans-serif] text-black/70 text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed">
                  MyChart should only be used for <span className="font-semibold">non-urgent</span> medical
                  matters. If you are experiencing a medical emergency,
                  please call <span className="font-semibold">911</span> immediately.
                  For urgent questions, call the clinic at{" "}
                  <a href="tel:2037771767" className="font-semibold text-[#00356b] underline hover:text-[#4a90c4] transition-colors">
                    (203) 777-1767
                  </a>.
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="font-['Poppins',sans-serif] text-black/70 text-[15px] md:text-[16px] leading-relaxed mb-4">
              Need to manage a family member&apos;s health information? MyChart proxy
              access allows you to view and manage records for your children, elderly
              parents, or other dependents.
            </p>
            <p className="font-['Poppins',sans-serif] text-black/70 text-[15px] md:text-[16px] leading-relaxed mb-6">
              To set up proxy access, please visit the front desk during your next
              appointment or contact the clinic. You will need to complete an
              authorization form.
            </p>
            <a
              href="tel:2037771767"
              className="inline-flex items-center gap-2 border-2 border-[#00356b] text-[#00356b] font-['Poppins',sans-serif] font-semibold text-[15px] md:text-[16px] px-7 py-3 rounded-full hover:bg-[#00356b]/5 transition-colors duration-300"
            >
              Contact the Clinic
            </a>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 py-16 md:py-20 lg:py-24">
        ...
        <p className="font-['Poppins',sans-serif] text-black/60 text-[16px] md:text-[18px] text-center max-w-[600px] mx-auto mb-10 md:mb-14">
          Have questions about MyChart? Find answers to common questions below.
          For anything else, please{" "}
          <a href="tel:2037771767" className="text-[#00356b] underline hover:text-[#4a90c4] transition-colors">
            contact us
          </a>.
        </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 lg:gap-20">
            <div className="flex-1">
              ...
              <p className="font-['Poppins',sans-serif] text-black/70 text-[16px] md:text-[18px] leading-relaxed mb-6 md:mb-8">
                Take your health information with you wherever you go. The MyChart
                mobile app gives you the same features as the web portal, optimized
