...
export const metadata: Metadata = {
  ...
  description:
    "Volunteer at HAVEN Free Clinic or support our mission through donations. Fall Volunteer Recruitment 2026 applications are open now and close September 12th.",
