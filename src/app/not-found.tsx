...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-white">
      ...
      <section className="relative w-full bg-[#034078] overflow-hidden pt-[120px] sm:pt-[140px] pb-16 sm:pb-20">
      ...
      <section className="flex-1 bg-gray-50">
        <div className="max-w-[900px] mx-auto px-6 py-12 md:py-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
            <Link
              href="/"
              className="flex items-center gap-2 bg-[#034078] text-white font-['Poppins',sans-serif] font-bold text-[15px] px-8 py-3.5 rounded-full hover:bg-[#02305a] transition-colors w-full sm:w-auto justify-center"
            >
            ...
            <button
              onClick={() => router.back()}
              className="flex items-center gap-2 bg-white text-[#034078] border-2 border-[#034078] font-['Poppins',sans-serif] font-bold text-[15px] px-8 py-3.5 rounded-full hover:bg-[#034078]/5 transition-colors w-full sm:w-auto justify-center"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-white text-gray-700 border-2 border-gray-300 font-['Poppins',sans-serif] font-bold text-[15px] px-8 py-3.5 rounded-full hover:bg-gray-50 transition-colors w-full sm:w-auto justify-center"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="group bg-white rounded-xl p-5 border border-gray-200 hover:border-[#034078]/30 hover:shadow-md transition-all"
              >
                <p className="font-['Poppins',sans-serif] font-bold text-gray-900 text-[16px] group-hover:text-[#034078] transition-colors mb-1">
                  {link.label}
                </p>
          ...
          <div className="mt-12 bg-white rounded-xl border border-gray-200 p-6 sm:p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="tel:2032000673"
                className="flex items-center gap-2 text-[#034078] font-['Poppins',sans-serif] font-bold text-[15px] hover:underline"
              >
              ...
              <a
                ...
                className="text-[#034078] font-['Poppins',sans-serif] font-bold text-[15px] hover:underline"
              >
